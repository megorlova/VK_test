...
@pytest.mark.parametrize("test_string, expected_result", [("hello", "HELLO"), ("Python", "PYTHON"), ("", "")])
def test_string_uppercase(test_string, expected_result):
    assert test_string.upper() == expected_result
